...
- **Role**: single proxy all AI traffic routes through — Claude Code/Kiro use OAuth passthrough to Anthropic (`forward_client_headers_to_llm_api: true` + `x-litellm-api-key` header), Hermes and Open WebUI route to OpenRouter
