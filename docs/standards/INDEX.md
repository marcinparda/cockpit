...
#### Technology Stack (`cockpit/tech-stack.md`)
...
- New patterns discovered during implementation should be added here directly, or noted in the relevant task's `work-log.md` for later promotion
- See [`../CONTRIBUTING.md`](../CONTRIBUTING.md) for which `docs/` folder a new file belongs in
