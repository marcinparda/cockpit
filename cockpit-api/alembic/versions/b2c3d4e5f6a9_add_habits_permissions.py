"""Add habits feature and permissions, assign to admin users
...
def upgrade() -> None:
    """Insert habits feature, 4 permissions, and assign all to admin users."""
...
def downgrade() -> None:
    """Remove habits permissions and feature row."""
    connection = op.get_bind()
